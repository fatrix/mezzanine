...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.private_access'
        db.add_column(u'blog_blogpost', 'private_access',
                      self.gf('django.db.models.fields.CharField')(max_length=34, null=True, blank=True),
                      keep_default=False)

        for blogpost in orm.Blogpost.objects.all():
            if blogpost.private_access is None:
                blogpost.private_access = os.urandom(16).encode('hex')
            blogpost.save()


    def backwards(self, orm):
        # Deleting field 'BlogPost.private_access'
        db.delete_column(u'blog_blogpost', 'private_access')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'private_access': ('django.db.models.fields.CharField', [], {'max_length': '34', 'null': 'True', 'blank': 'True'}),
